...
def run_papers(
    ...
    def _fetch() -> dict:
        ...
        return {"papers": papers, "dupes": dupes}

    result = get_or_fetch(
        "papers", {"queries": queries, "sources": sources, "recency_days": recency_days, "num_results": num_results}, _fetch
    )
    papers, dupes = result["papers"], result["dupes"]
